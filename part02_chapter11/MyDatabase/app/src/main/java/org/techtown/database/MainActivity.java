...
public class MainActivity extends AppCompatActivity {
    ...
    public void createDatabase(String databaseName) {   //데이터베이스를 생성하는 함수
    ...
    public void createTable(String tableName) {     //데이터베이스에 테이블 생성하는 함수
    ...
    public void insertRecord() {    //레코드 삽입 메소드
        ...
        String sql = "insert into " + tableName + " (name, age, mobile) values ('john', 20, '010-0000-1111')";
        database.execSQL(sql);
        println("레코드 추가함");
    }

    public void executeQuery() {    //조회 메소드
